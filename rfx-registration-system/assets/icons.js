...
(function () {
  ...
  const icons = {
    ...
    flame:      S('<path d="M12 2s5 4.4 5 9a5 5 0 0 1-10 0c0-1.1.3-2.1.9-3C6.7 9.6 12 7.6 12 2z"/><path d="M12 22c2.9 0 4.7-1.7 4.7-4.3 0-2.9-3.1-5-4.7-8.2-1.6 3.2-4.7 5.3-4.7 8.2 0 2.6 1.8 4.3 4.7 4.3z"/>'),
